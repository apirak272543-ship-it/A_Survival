...
- Implementation: [`server/generators/commonGeneratorApi.ts`](../server/generators/commonGeneratorApi.ts), [`server/generators/dependencyGraph.ts`](../server/generators/dependencyGraph.ts), [`server/generators/contentCatalogDependencyGraph.ts`](../server/generators/contentCatalogDependencyGraph.ts)
- Tests: [`server/commonGeneratorApi.test.ts`](../server/commonGeneratorApi.test.ts), [`server/dependencyGraph.test.ts`](../server/dependencyGraph.test.ts), [`server/contentCatalogDependencyGraph.test.ts`](../server/contentCatalogDependencyGraph.test.ts)
