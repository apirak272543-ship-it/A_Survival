...
| `RESERVED` | AI-0 | `NEXT-CREDITS-PROVENANCE-001` | C-03 sub-checkpoint: pure runtime/reference-only credits presentation contract from `ASSET_CREDITS`; no CreditsSheet/player UI edit or asset publish in this round |
