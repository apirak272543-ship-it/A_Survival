...
| `RESERVED` | AI-0 | `NEXT-WORLD-SPATIAL-001` | G-02 sub-checkpoint: pure bounded spatial dependency graph from world generator/constraints; no player generator UI, runtime map selection or world persistence |
