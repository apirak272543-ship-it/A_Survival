...
| `RESERVED` | AI-0 | `NEXT-ITEM-DETAIL-001` | C-02 sub-checkpoint: pure category-specific item detail facts from canonical ItemDefinition/ItemInstance; unavailable combat fields remain explicit blockers; no ArcaneFrontier UI, persistence caller or runtime mutation |
