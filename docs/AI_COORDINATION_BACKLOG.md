...
| `RESERVED` | AI-0 | `NEXT-CREDITS-UI-BOUNDARY-001` | C-03 sub-checkpoint: connect existing CreditsSheet to `createCreditsPresentation(ASSET_CREDITS)` with fail-closed canonical sections; no asset bytes, publish, persistence, network write or creator control |
