...
| `RESERVED` | AI-0 | `NEXT-MOBILE-VIEWPORT-001` | M-01 sub-checkpoint: pure viewport/safe-area/orientation/touch/fullscreen policy for landscape WebView; no CSS/index.html/GameCanvas edit or real-device acceptance claim in this round |
