...
| `RESERVED` | AI-0 | `NEXT-ASSET-PROVENANCE-001` | T-04/F-01 sub-checkpoint: pure item/plant asset provenance dependency graph against active manifest/credits; no binary asset generation, Workbench edit or runtime publish |
