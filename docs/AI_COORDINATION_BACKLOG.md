...
| `RESERVED` | AI-0 | `NEXT-ITEM-DETAIL-UI-BOUNDARY-001` | C-02 sub-checkpoint: connect existing long-press ItemDetailSheet to `getItemCategoryDetail`; show only canonical usage/stack/plant/block/tool facts and explicit unavailable attack damage; no fabricated combat stat or persistence change |
