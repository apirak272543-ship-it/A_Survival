...
| `RESERVED` | AI-0 | `NEXT-CODEX-DISCOVERY-001` | C-01 sub-checkpoint: pure discovered-only Codex normalization/transition from `CODEX_ENTRIES`; no UI or persistence side effect in this round |
