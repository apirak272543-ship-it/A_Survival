...
| `RESERVED` | AI-0 | `NEXT-PLANT-ECOLOGY-001` | F-07 sub-checkpoint: pure data-driven plant ecology policy from the 300-entry catalog covering soil/biome/lifecycle and bounded fictional nutrient/pest/season factors; no real ecology simulation, gameplay mutation, `worldFarmSystem.ts` edit or player UI |
