...
| `RESERVED` | AI-0 | `NEXT-CODEX-UI-BOUNDARY-001` | C-01 sub-checkpoint: connect existing CodexSheet to the pure discovered-only projection; no discovery event, persistence, network write or player map/control change in this round |
