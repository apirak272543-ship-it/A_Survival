...
| `RESERVED` | AI-0 | `NEXT-S03-TARGET-FPS-DISCLOSURE-001` | S-03 sub-checkpoint: clarify 120 FPS option as high-refresh advisory/non-guarantee in player settings; no runtime normalization, FPS benchmark, device acceptance or map/cache policy change |
