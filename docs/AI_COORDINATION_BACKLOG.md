...
| `RESERVED` | AI-0 | `NEXT-MOBILE-VIEWPORT-CSS-BOUNDARY-001` | M-01 sub-checkpoint: add narrow actual safe-area/landscape responsive CSS for existing player HUD/control anchors and high-risk overflow surfaces; exact file `client/src/index.css`; preserve policy/index.html/GameCanvas/Obsidian-only runtime; browser widths 320/390/430/768 are viewport evidence only |
