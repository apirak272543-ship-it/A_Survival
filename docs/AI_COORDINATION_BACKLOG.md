...
| `RESERVED` | AI-0 | `NEXT-ANIMATION-MOTION-001` | T-02 sub-checkpoint: pure distance/visibility/reduced-motion animation policy and bounded motion profile metadata; no binary asset generation, GameCanvas caller edit, skeleton/retarget/device benchmark or player UI |
