...
| Texture handoff | `creator.composition.texturePreview` แปลง sparse cells เป็น RGBA ผ่าน existing `texture.pack` builder พร้อม composition SHA ใน provenance; เป็น transient preview เท่านั้น |
