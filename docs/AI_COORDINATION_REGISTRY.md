...
| `AI1-G05-001` | AI-1 | ⚪ WAITING_EVIDENCE | G-05 runtime asset provenance audit; files: `server/generators/runtimeAssetProvenanceAudit.ts`, `server/runtimeAssetProvenanceAudit.test.ts`; ตรวจเฉพาะ manifest/credits/source/license/reference-only boundary; ห้ามสร้าง PNG/GLB, แก้ `assetProvenance.ts`, Workbench/router, map/cache/offline/authority หรือไฟล์ใน reservation ของ AI-0/AI-2 | Base `330593c`; branch `ai1/g05-runtime-asset-provenance`; implementation `1f2900852a4aba659239c4dbeba3448a4a91d9d6`; PR [#7](https://github.com/apirak272543-ship-it/A_Survival/pull/7); focused 1 file/5 tests, full 109 files/433 tests, `pnpm check`, `git diff --check`, production build ผ่าน | รอ AI-0 ตรวจ diff และหลักฐาน แล้วเปลี่ยนเป็น 🟢 DONE หรือแจ้ง blocker |
