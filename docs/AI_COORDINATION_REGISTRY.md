...
| `AI1-S03-001` | AI-1 | 🔵 IN_PROGRESS | S-03 view distance 5–50 step 5 และ target FPS 5–60+120; reserved files: `server/generators/runtimeRenderSettings.ts`, `server/runtimeRenderSettings.test.ts`, `docs/AI_COORDINATION_REGISTRY.md`; ห้ามอ้าง benchmark และห้ามแก้ player map policy, Workbench, router authorization, map/cache/offline/authority หรือไฟล์ใน reservation ของ AI-0 | Base `1a02849`; branch `ai1/s03-render-settings`; claim ส่งแล้ว | ทำหนึ่ง deterministic/read-only settings และ streaming contract, ตรวจ normalization/fallback และส่ง evidence ให้ AI-0 |
