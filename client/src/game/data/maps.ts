...
const curatedFirstFifteen: MapDefinition[] = [
  { id: "obsidian-frontier", name: "Obsidian Frontier", biome: "Obsidian Alien Frontier", subtitle: "ฐานวิจัยพลังงานที่แตกสลายและรอยแยกต่างดาว", radiusMeters: 500, threat: 1, accent: "#00f3ff", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map001-obsidian-outpost_09f41a7e.jpg", loadingCopy: "สัญญาณออบซิเดียนยังไม่เสถียร จงเตรียมอาวุธและเส้นทางกลับ Outpost", eventBossName: "Void Reaper", content: content("Commander Koral", "Crashed Leyline Monolith", "Ley Crystal and frontier alloy", "Distress pod trap", "Glass Stalker", "Obsidian Golem", "Void Reaper") },
  { id: "map-002-ashen-obsidian-plains", name: "Ashen Obsidian Plains", biome: "Obsidian Alien Frontier", subtitle: "ทุ่งหินดำและรอยแยกแมกม่าใต้พายุเถ้าถ่าน", radiusMeters: 500, threat: 1, accent: "#ff4500", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_002-ashen-obsidian-plains_3ad69f5e.jpg", loadingCopy: "ระวังใต้เท้าของคุณ หินออบซิเดียนคมพอจะกรีดรองเท้าหนาของคุณได้", eventBossName: "Pyroclastic Behemoth", content: content("Scavenger Jax", "Magma Fissure Relay", "Obsidian Shards, Volcanic Ash, Sulfur Crystals", "Ash storm doubles rare drops", "Ash Crawler", "Obsidian Shell Golem", "Pyroclastic Behemoth") },
  { id: "map-003-bioluminescent-caverns", name: "Bioluminescent Caverns", biome: "Obsidian Alien Frontier", subtitle: "ถ้ำออบซิเดียนใต้ดินที่ส่องด้วยสปอร์ไซยาൻ", radiusMeters: 500, threat: 1, accent: "#00ffff", timeMode: "void", status: "prototype", keyArt: "/manus-storage/map_003-bioluminescent-caverns_fcc8025b.jpg", loadingCopy: "อย่าออกนอกเส้นทางที่มีแสง ความมืดในถ้ำกำลังจ้องมองคุณอยู่", eventBossName: "Mycelium Empress", content: content("Researcher Lyra", "Surface Safety Rope", "Luminescent Moss, Glow Crystals, Spore Pouches", "Spore bloom heals player but enrages enemies", "Glow Spore Beetle", "Luminous Stalker", "Mycelium Empress") },
  { id: "map-004-crystalline-spires", name: "Crystalline Spires", biome: "Obsidian Alien Frontier", subtitle: "หุบเขาผลึกม่วงคมและทางแคบที่สะท้อนแสงต่างดาว", radiusMeters: 500, threat: 2, accent: "#9932cc", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_004-crystalline-spires_337a1e45.jpg", loadingCopy: "สังเกตเงาของเสาหินเพื่อใช้เป็นที่กำบังจากแสงสะท้อน", eventBossName: "Resonance Archon", content: content("Cartographer Zephyr", "Resonance Pillars", "Resonating Quartz, Crystal Shards, Charged Dust", "Random reflection laser field", "Shard Gnat", "Prism Golem", "Resonance Archon") },
  { id: "map-005-corrosive-acid-swamps", name: "Corrosive Acid Swamps", biome: "Obsidian Alien Frontier", subtitle: "บึงน้ำกรดพิษและสะพานไม้ที่เป็นเส้นทางปลอดภัย", radiusMeters: 500, threat: 2, accent: "#32cd32", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_005-corrosive-acid-swamps_06c2e49f.jpg", loadingCopy: "สวมรองเท้ากันกรดให้แน่น การก้าวพลาดเพียงครั้งเดียวอาจหมายถึงชีวิต", eventBossName: "Toxic Hydra", content: content("Alchemist Vane", "Acid Boardwalk Haven", "Acidic Sap, Corrosive Sludge, Toxic Lily", "Acid rain forces shelter play", "Acid Slime", "Mire Lurker", "Toxic Hydra") },
  { id: "map-006-magnetic-dunes", name: "Magnetic Dunes", biome: "Obsidian Alien Frontier", subtitle: "เนินทรายเหล็กดำ เศษซากลอยตัว และพายุแม่เหล็ก", radiusMeters: 500, threat: 2, accent: "#ffd700", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_006-magnetic-dunes_53e50b18.jpg", loadingCopy: "เข็มทิศใช้ไม่ได้ในสนามแม่เหล็กนี้ จงเชื่อแผนที่ออฟไลน์ของคุณ", eventBossName: "Lodestone Colossus", content: content("Engineer Rusty", "Magnetic Stabilizer", "Magnetite Sand, Iron Ore, Floating Shards", "Magnetic storm disturbs metal loadouts", "Magnetic Hover-Ray", "Ironclad Golem", "Lodestone Colossus") },
  { id: "map-007-frozen-obsidian-crevasses", name: "Frozen Obsidian Crevasses", biome: "Obsidian Alien Frontier", subtitle: "รอยแยกน้ำแข็งและท่อไอน้ำที่เป็นแหล่งความร้อน", radiusMeters: 500, threat: 2, accent: "#00bfff", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_007-frozen-obsidian-crevasses_16dab169.jpg", loadingCopy: "ความเย็นสามารถแช่แข็งเลือดของคุณได้เมื่ออยู่ห่างจากไอน้ำ", eventBossName: "Glacial Terror", content: content("Scout Frost", "Steam Vent Haven", "Glacial Ice, Frostweed, Cryo-Crystals", "Blizzard drives players to steam vents", "Frostbite Weaver", "Cryo-Beast", "Glacial Terror") },
  { id: "map-008-ancient-obsidian-ruins", name: "Ancient Obsidian Ruins", biome: "Obsidian Alien Frontier", subtitle: "วิหารเอเลี่ยนโบราณ ระบบป้องกันยังทำงานและรูนทองส่องแสง", radiusMeters: 500, threat: 3, accent: "#daa520", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_008-ancient-obsidian-ruins_487bc022.jpg", loadingCopy: "ระบบป้องกันภัยโบราณยังสมบูรณ์ อย่าประมาทซากอารยธรรม", eventBossName: "Matrix Overlord", content: content("Historian Kael", "Rune Terminal", "Ancient Relic, Energy Core, Relic Metal", "Defense system sweeps the hall with lasers", "Sentinel Drone", "Ruin Guardian", "Matrix Overlord") },
  { id: "map-009-overgrown-obsidian-jungle", name: "Overgrown Obsidian Jungle", biome: "Obsidian Alien Frontier", subtitle: "ป่าเอเลี่ยนเรืองแสงที่รากดำและดอกไม้กินเนื้อครอบงำเส้นทาง", radiusMeters: 500, threat: 3, accent: "#2e8b57", timeMode: "cycle", status: "prototype", keyArt: "/manus-storage/map_009-overgrown-obsidian-jungle_08f72bb5.jpg", loadingCopy: "ฝนพิษจากเรือนยอดจะบีบให้คุณหาทางกลับ Canopy Haven", eventBossName: "Verdant Hive Mind", content: content("Botanist Iris", "Canopy Haven & Verdant Hive Root", "Alien Bloom, Vine Fibers, Jungle Sap", "Toxic Downpour forces canopy shelter play", "Vine Stalker", "Thornback Behemoth", "Verdant Hive Mind") },
  { id: "map-010-void-infused-rift", name: "Void-Infused Rift", biome: "Obsidian Alien Frontier", subtitle: "เกาะหินลอยและรอยแยกมิติที่มี portal pad กลับค่ายเสมอ", radiusMeters: 500, threat: 3, accent: "#8a2be2", timeMode: "void", status: "prototype", keyArt: "/manus-storage/map_010-void-infused-rift_d6554529.jpg", loadingCopy: "จงอยู่ใกล้ portal pad เมื่อแรงโน้มถ่วงของรอยแยกเริ่มแปรปรวน", eventBossName: "Void Singularity", content: content("Void Wanderer", "Stable Rift Pylons", "Void Essence, Dark Matter Dust, Rift Alloy", "Gravity tide rotates stable routes", "Void Larva", "Rift Horror", "Void Singularity") },

  { id: "map-011-cinder-caldera", name: "Cinder Caldera", biome: "Obsidian Alien Frontier", subtitle: "ปล่องลาวาที่เปิดเป็นช่วงและหินบะซอลต์เย็นเป็นเส้นทางรอด", radiusMeters: 500, threat: 2, accent: "#ff4d1a", timeMode: "cycle", status: "prototype", keyArt: "https://image.pollinations.ai/prompt/active%20lava%20vents%20in%20a%20dark%20obsidian%20caldera%20with%20cooled%20basalt%20paths%2C%20dark%20fantasy%20sci-fi%20game%20environment%20concept%20art%2C%20no%20text%20no%20ui?width=1024&height=576&model=flux&nologo=true&seed=11011", loadingCopy: "ระวังพื้นใต้เท้า ปล่องลาวาจะพ่นความร้อนเป็นจังหวะ", eventBossName: "Ignis Colossus", content: content("Forgemaster Vael", "Shattered Smelter Arch", "Cinder Bloom, Basalt Slag, Pyrite Chunk", "Lava surge closes crossings with superheated steam", "Cinder Crawler", "Pyroclast Brute", "Ignis Colossus") },
  { id: "map-012-obsidian-spire-shelf", name: "Obsidian Spire Shelf", biome: "Obsidian Alien Frontier", subtitle: "หน้าผาหินดำสูงและลมเถ้าถ่านที่ลดระยะโจมตีระยะไกล", radiusMeters: 500, threat: 3, accent: "#8c1aff", timeMode: "cycle", status: "prototype", keyArt: "https://image.pollinations.ai/prompt/sheer%20black%20obsidian%20plateaus%20in%20howling%20ash%20gales%2C%20dark%20fantasy%20sci-fi%20game%20environment%20concept%20art%2C%20no%20text%20no%20ui?width=1024&height=576&model=flux&nologo=true&seed=11012", loadingCopy: "ลมแรงจะเบี่ยงกระสุน ใช้การโจมตีระยะประชิดหรือหาที่กำบัง", eventBossName: "Gale-Terror Zephyr", content: content("Scout Kaelen", "Monolith of the North Wind", "Razor Glass, Obsidian Shard, Wind-Carved Bone", "Ash squall drops visibility and spawns stalkers", "Spire Stalker", "Gale-Talon Alpha", "Gale-Terror Zephyr") },
  { id: "map-013-brimstone-mire", name: "Brimstone Mire", biome: "Obsidian Alien Frontier", subtitle: "บึงกำมะถันพิษที่สะสมกัดกร่อนเกราะและเลือด", radiusMeters: 500, threat: 3, accent: "#c4e61a", timeMode: "cycle", status: "prototype", keyArt: "https://image.pollinations.ai/prompt/toxic%20yellow%20sulfur%20pools%20in%20a%20dark%20obsidian%20mire%2C%20dark%20fantasy%20sci-fi%20game%20environment%20concept%20art%2C%20no%20text%20no%20ui?width=1024&height=576&model=flux&nologo=true&seed=11013", loadingCopy: "เกราะจะถูกกัดกร่อนในบึง จงเคลื่อนที่บนเส้นทางสูง", eventBossName: "Bile-Mother Vile", content: content("Alchemist Theron", "Boiling Sulfur Falls", "Sulfur Crust, Acid Gland, Bog Iron", "Sulfur geyser creates temporary poison zones", "Mire Leaper", "Corrosive Aberration", "Bile-Mother Vile") },
  { id: "map-014-magma-trench-bastion", name: "Magma Trench Bastion", biome: "Obsidian Alien Frontier", subtitle: "สะพานแคบเหนือร่องลาวาและป้อมปราการที่ร้าง", radiusMeters: 500, threat: 4, accent: "#ff2a00", timeMode: "cycle", status: "prototype", keyArt: "https://image.pollinations.ai/prompt/narrow%20obsidian%20bridges%20over%20glowing%20magma%20trenches%20near%20a%20ruined%20citadel%2C%20dark%20fantasy%20sci-fi%20game%20environment%20concept%20art%2C%20no%20text%20no%20ui?width=1024&height=576&model=flux&nologo=true&seed=11014", loadingCopy: "อย่าหยุดนิ่งบนสะพาน ดินสั่นสะเทือนจะทำให้สะพานพัง", eventBossName: "Trench-Lord Baelrok", content: content("Warden Sonya", "Ruined Citadel Gate", "Hardened Magma, Bastion Alloy, Drake Scale", "Bridge collapse forces platform hopping", "Bastion Hound", "Magma Drake Sentinel", "Trench-Lord Baelrok") },
  { id: "map-015-heart-of-the-crucible", name: "Heart of the Crucible", biome: "Obsidian Alien Frontier", subtitle: "หัวใจเตาหลอมที่ร้อนขึ้นเรื่อย ๆ ดูดสเตมินาและโล่", radiusMeters: 500, threat: 5, accent: "#ff0055", timeMode: "cycle", status: "prototype", keyArt: "https://image.pollinations.ai/prompt%20a%20massive%20glowing%20anvil%20at%20the%20heart%20of%20a%20volcanic%20crucible%20of%20obsidian%20and%20fire%2C%20dark%20fantasy%20sci-fi%20game%20environment%20concept%20art%2C%20no%20text%20no%20ui?width=1024&height=576&model=flux&nologo=true&seed=11015", loadingCopy: "ความร้อนจะดูดพลังของคุณทุกวินาที หาจุดพักที่ Forge Shrine", eventBossName: "The Crucible Overlord", content: content("Avatar of the Forge", "The Primal Core Anvil", "Primal Core Ember, Pure Obsidian Crystal, Ancient Furnace Core", "Core pulse triggers map-wide shockwave", "Crucible Myrmidon", "Dread Infernal Goliath", "The Crucible Overlord") },
];

const regionWords = ["Reach", "Basin", "Hollow", "March", "Spine", "Veil", "Run", "Crown", "Fields", "Circuit", "Rift", "Expanse", "Gate"];

const plannedMaps: MapDefinition[] = Array.from({ length: 85 }, (_, offset) => {
  const index = offset + curatedFirstFifteen.length;
...
export const MAP_REGISTRY: MapDefinition[] = [...curatedFirstFifteen, ...plannedMaps];
