...
import { CREATOR_TEMPLATE_PRESETS } from "@/lib/creatorTemplateCatalog";
...
export default function CreatorDomainWorkbench() {
  ...
  const compositionTemplates = CREATOR_TEMPLATE_PRESETS.filter(template => template.kind !== "atlas");
