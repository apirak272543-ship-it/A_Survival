...
export default function CreatorDomainWorkbench() {
  ...
  const lastError = worldPreview.error ?? blockPreview.error ?? structurePreview.error ?? itemPreview.error ?? weaponPreview.error ?? animationPreview.error ?? compositionPreview.error ?? compositionTexturePreview.error ?? compositionTextureExportPreview.error ?? questPreview.error ?? profilerPreview.error ?? artifactPreview.error ?? artifactRegister.error ?? artifactReview.error ?? artifactExport.error ?? artifactCompatibility.error ?? artifactList.error ?? artifactAudit.error;
